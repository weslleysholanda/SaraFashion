    ...
    public function adicionar()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (!$foto_funcionario) {
                ...
                header('Location: https://sarafashion.webdevsolutions.com.br/public/funcionario/adicionar');
                exit;
            }
            ...
            try {
                ...
                if ($id_funcionario) {
                    ...
                    header('Location: https://sarafashion.webdevsolutions.com.br/public/funcionario/listar');
                    exit;
                } else {
    ...
    public function editar($id = null)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!$foto_funcionario) {
                ...
                $_SESSION['tipo-msg'] = 'erro';
                header('Location: https://sarafashion.webdevsolutions.com.br/public/funcionario/editar/' . $id);
                exit;
            }
