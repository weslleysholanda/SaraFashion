    ...
    public function adicionar()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($id_especialidade)) {
                ...
                header('Location: https://sarafashion.webdevsolutions.com.br/public/servico/adicionar');
                exit;
            }
    ...
    public function editar($id = null)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!$foto_servico) {
                ...
                $_SESSION['tipo-msg'] = 'erro';
                header('Location: https://sarafashion.webdevsolutions.com.br/public/servico/editar/' . $id);
                exit;
            }
