    ...
    public function editar($id = null){
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($atualizado) {
                ...
                header('Location: https://sarafashion.webdevsolutions.com.br/public/especialidade/listar');
                exit;
            } else {
                $_SESSION['mensagem'] = "Erro ao atualizar a logo da marca";
                $_SESSION['tipo-msg'] = "erro";
                header('Location: https://sarafashion.webdevsolutions.com.br/public/especialidade/editar/' . $id);
                exit;
            }
        }
