        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (!empty($nome_produto) && !empty($descricao_produto) && $preco_produto !== false) {
                ...
                if ($id_produto) {
                    ...
                    header('Location: https://sarafashion.webdevsolutions.com.br/public/produto/listar');
                    exit;
                } else {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($nome_produto && $descricao_produto && $preco_produto !== false) {
                ...
                if ($resultado) {
                    ...
                    $_SESSION['tipo-msg'] = "erro";
                    header('Location: https://sarafashion.webdevsolutions.com.br/public/produto/adicionar');
                    exit;
                }
            }
        }
