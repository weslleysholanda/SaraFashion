...
<section class="nossa-historia">
    <div class="site">
        <div class="container-principal">
            <div class="container-historia-left">
                <div class="primary-left-image">
                    <figure class="reveal">
                        <div class="hover-anime">
                            <img src="assets/img/sobre-img-1.jpg" class="img-filter" alt="">
                        </div>
                    </figure>
                </div>
            ...
            <div class="container-historia-right">
                <div class="titulo-historia">
                    <div class="textoFundo">About her</div>
                    <h2>Sobre</h2>
                    <h2>Sara Fashion</h2>
                </div>
