    ...
    <div class="site">
        ...
        <nav class="menu">
            <ul>
                ...
                <li>
                    <a href="http://localhost/sarafashion/public/loja"  class="ativo">Loja</a>
                </li>
            </ul>
