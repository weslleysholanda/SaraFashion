...
<section class="vale-presente">
    <div class="site">
        <div class="container-vale-left">
            <div class="list-card">
                <div class="card">
                    <div class="card-logo">
                        <img src="assets/img/logo-teste.png" alt="Logo">
                    </div>
                    <h4>PREMIUM</h4>
                    <h2>VALE PRESENTE</h2>
                    <div class="textoFundo">HairCare</div>
                    <div class="line"></div>
                    <div class="card-footer">
                        <p>T: 11 983612610</p>
                        <p>E: sara_silva1502@hotmail.com</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-logo">
        ...
        <div class="conteudo-vale-right">
            ...
            <a href="https://sarafashion.webdevsolutions.com.br/public/loja">VER PRODUTOS</a>
        </div>
    </div>
</section>