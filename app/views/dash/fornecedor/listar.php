...
<div class="navTool">
    ...
    <div class="navTool-button">
        <a href="/fornecedor/adicionar">ADICIONAR</a>
    </div>
</div>
    ...
    <tbody>
        <?php foreach ($listarFornecedor as $linha): ?>
            <tr>
                ...
                <td id="text-center"><a href="/fornecedor/editar/<?php echo $linha['id_fornecedor'] ?>"><i id="btn-primary" class="bi bi-pencil"></i></a></td>
