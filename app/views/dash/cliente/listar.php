...
<div class="navTool">
    ...
    <div class="navTool-button">
        <a href="https://sarafashion.webdevsolutions.com.br/public/cliente/adicionar">ADICIONAR</a>
    </div>
</div>
        ...
        <tbody id="tabela-cliente">
            <?php foreach ($listarCliente as $linha): ?>
                <tr>
                    ...
                    <td id="text-center"><a href="https://sarafashion.webdevsolutions.com.br/public/cliente/editar/<?php echo $linha['id_cliente'] ?>"><i id="btn-primary" class="bi bi-pencil"></i></a></td>
                    <td>
