        ...
        <?php foreach ($listarProduto as $linha): ?>
            <tr>
                <td class="imgBanco">
                    ...
                    if (isset($imagens[3])) {
                        $imagemPrincipal = $imagens[3]; // Define a principal como a da posição [3]
                        unset($imagens[3]); // Remove essa imagem do array para evitar duplicação
                        array_unshift($imagens, $imagemPrincipal); // Coloca ela na posição [0]
                    } else {
