        ...
        <?php foreach ($listarProduto as $linha): ?>
            <tr>
                <td class="imgBanco">
                    ...
                    <a href="/uploads/<?php echo htmlspecialchars($imagemPrincipal, ENT_QUOTES, 'UTF-8'); ?>"
                    ...
                    <?php foreach ($imagens as $index => $imagem): ?>
                        <?php if ($index > 0): ?>
                            <a href="/uploads/<?php echo htmlspecialchars($imagem, ENT_QUOTES, 'UTF-8'); ?>"
                                data-lightbox="produto-<?php echo $linha['id_produto']; ?>"
                ...
                <td><a href="/produto/editar/<?php echo $linha['id_produto'] ?>"><i id="btn-primary" class="bi bi-pencil"></i></a></td>
