...
<div class="navTool">
    ...
    <div class="navTool-button">
        <a href="https://sarafashion.webdevsolutions.com.br/public/servico/adicionar">ADICIONAR</a>
    </div>
</div>
        ...
        <tbody id="tabela-servico">
            <?php foreach ($listarServico as $linha): ?>
                <tr>
                    <td class="imgBanco"><img src="<?php
                                                    ...
                                                    if ($linha['foto_servico'] != "") {
                                                        if (file_exists($caminhoArquivo)) {
                                                            echo ("https://sarafashion.webdevsolutions.com.br/public/uploads/" . htmlspecialchars($linha['foto_servico'], ENT_QUOTES, 'UTF-8'));
                                                        } else {
                    ...
                    <td><a href="https://sarafashion.webdevsolutions.com.br/public/servico/editar/<?php echo $linha['id_servico'] ?>"><i id="btn-primary" class="bi bi-pencil"></i></a></td>
                    <td>
