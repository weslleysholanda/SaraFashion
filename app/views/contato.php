...
<body>
    ...
    <script src="http://localhost/sarafashion/public/vendors/js/slick.min.js"></script>
    <script src="https://unpkg.com/@popperjs/core@2"></script>
    <script src="https://unpkg.com/tippy.js@6"></script>
    <script src="https://unpkg.com/counterup2@2.0.2/dist/index.js"></script>
    <script src="https://kit.fontawesome.com/89bd08d7e0.js" crossorigin="anonymous"></script>
    <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
    <script src="http://localhost/sarafashion/public/assets/js/maps.js"></script>
    <script src="http://localhost/sarafashion/public/assets/js/script.js"></script>
</body>
